...
local function selectCurrentWorkspace(focusedWorkspaceName)
  for sid, item in pairs(spaces) do
    if item ~= nil then
      ...
      item:set({
        icon = { color = isSelected and settings.colors.white or settings.colors.dirty_white},
        label = { color = isSelected and settings.colors.white or settings.colors.dirty_white },
        background = { color = isSelected and settings.colors.dark_grey or settings.colors.dark_grey },
      })
    end
  end
